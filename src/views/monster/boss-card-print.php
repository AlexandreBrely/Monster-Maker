<?php
/**
 * Boss Monster Card - PRINT VERSION (No page wrapper)
 * Extracted card HTML from boss-card.php without header/navbar/footer
 * Used ONLY for PDF generation - includes just the card content
 */
// ?? operator ensures undefined variables become empty arrays instead of errors
$traits = $traits ?? [];
$actions = $actions ?? [];
