<?php
/**
 * Internal API: Add monster to collection (POST)
 * Thin wrapper that delegates business logic to CollectionController.
 */
...
if (!$input || !isset($input['monster_id']) || !isset($input['collection_id'])) {
    ...
    echo json_encode(['success' => false, 'message' => 'Missing required fields: monster_id, collection_id']);
    exit;
}
